# Hiter test
# python -c "import json; d=json.load(open('ip_rs_mnenja_zvop2.json', encoding='utf-8')); print(len(d)); print(d[:3])"
...
OUTPUT_FILE = "ip_rs_mnenja_zvop2_fizicne_posamezniki.json"
